...
contract QACrowdsale is Ownable,ReentrancyGuard, DSMath {
    ...
    uint256 public maxPayment = 1e9;  //1000 tokens with 6 decimals
    uint256 constant public SALE_TOKEN_PARTS = 1e18;
    mapping(address => bool) internal whiteList;
    address public finance;
    iVotingEscrow public lockContract;
    ...
    function buy(uint256 _payment, uint8 _sellOption) external nonReentrant {
        ...
        require(maxPayment >= _payment, "Amount exceeds maximum payment for address");
        ...
        uint256 sellAmount = wdiv(payment, paymentPrice_);
